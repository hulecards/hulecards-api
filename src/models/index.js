...
db.depositrequests = require("../models/depositrequest.model")(sequelize, Sequelize);
db.depositpayments = require("../models/depositpayment.model")(sequelize, Sequelize);
...
db.cards.hasMany(db.depositpayments, {
	foreignKey: 'cardId', targetKey: 'id'
});
